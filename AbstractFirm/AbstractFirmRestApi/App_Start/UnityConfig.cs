...
namespace AbstractFirmRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IKlientService, KlientServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IBlankService, BlankServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<ILawyerService, LawyerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IPackageService, PackageServiceBD>(new HierarchicalLifetimeManager());
